/*
  ...
  - Added the required column `updatedAt` to the `ProhibitedWord` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Category" ("id", "name", "slug", "updatedAt") SELECT "id", "name", "slug", CURRENT_TIMESTAMP FROM "Category";
DROP TABLE "Category";
...
INSERT INTO "new_ProhibitedWord" ("category", "createdAt", "id", "word", "updatedAt") SELECT "category", "createdAt", "id", "word", CURRENT_TIMESTAMP FROM "ProhibitedWord";
